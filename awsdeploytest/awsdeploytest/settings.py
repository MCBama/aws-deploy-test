"""
Django settings for awsdeploytest project.
...
SECRET_KEY = '9!1ei(4bmqrf(xx0pbop$*^@@s^z%%%m(h9j9d=pts2w@sl%va'
...
ROOT_URLCONF = 'awsdeploytest.urls'
...
WSGI_APPLICATION = 'awsdeploytest.wsgi.application'
